  ...
  exports.SelectMode = {
    display: function (callbacks) {
      if (this.selectModeBackground === undefined) {
        ...
        this.selectMode.className = "pageshot-select-mode";
        this.selectMode.textContent = "Choose what to save";
        this.selectModeBackground.appendChild(this.selectMode);
        this.modes = document.createElement("div");
        this.chooseRegionMode = document.createElement("button");
        this.chooseRegionMode.className = "pageshot-select-mode-square-button";
        this.chooseRegionMode.style.left = "60px";
        ...
        this.chooseRegionMode.appendChild(regionImg);
        this.chooseRegionMode.appendChild(document.createTextNode("Screenshot Region"));
        this.chooseRegionMode.onclick = callbacks.onChooseRegionMode;
        this.modes.appendChild(this.chooseRegionMode);
        this.chooseArchiveMode = document.createElement("button");
        this.chooseArchiveMode.className = "pageshot-select-mode-square-button";
        this.chooseArchiveMode.style.right = "60px";
        ...
        this.chooseArchiveMode.appendChild(archiveImg);
        this.chooseArchiveMode.appendChild(document.createTextNode("Archive Full Page"));
        this.chooseArchiveMode.onclick = callbacks.onChooseArchiveMode;
        this.modes.appendChild(this.chooseArchiveMode);
        this.selectMode.appendChild(this.modes);
        this.buttons = document.createElement("div");
        this.cancelButton = document.createElement("button");
        this.cancelButton.className = "pageshot-select-mode-button";
        this.cancelButton.textContent = "Cancel";
        this.cancelButton.style.left = "0";
        this.cancelButton.onclick = callbacks.onCancel;
        this.myShotsButton = document.createElement("button");
        this.myShotsButton.className = "pageshot-select-mode-button";
        this.myShotsButton.textContent = "Open My Shots";
        this.myShotsButton.style.right = "0";
        this.myShotsButton.style.backgroundColor = "#248aeb";
        this.myShotsButton.style.color = "white";
        this.myShotsButton.onclick = callbacks.onOpenMyShots;

        this.buttons.appendChild(this.cancelButton);
        this.buttons.appendChild(this.myShotsButton);
        this.selectMode.appendChild(this.buttons);
      }
