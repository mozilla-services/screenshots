...
footerLinkRemoveAllData = Dilemel an holl roadennoù
...
creatingPageTitle = O krouiñ { $title }
creatingPageTitleDefault = pajenn
creatingPageWaitMessage = Oc'h enrollañ ho tapadenn...

## Home page

homePageDescription =
    .content = Tapadennoù skramm nadel savet e-barzh ar merdeer. Skeudennit, enrollit ha rannit tapadennoù-skramm e-pad m'emaoc'h o merdeiñ ar Web gant FIrefox.
homePageButtonMyShots = Mont d'am zapadennoù
...
annotationCropButton =
    .title = Troc'hañ
annotationSaveEditButton = Enrollañ
    .title = Enrollañ an embann
annotationCancelEditButton = Nullañ
    .title = Nullañ an embann
annotationCropConfirmButton = Kadarnat
