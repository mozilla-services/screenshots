...
shutdownPageDescription = Haziran ayından itibaren Screenshots çevrimiçi depolama olanağı sunmayacak. Arşivinizdeki ekran görüntülerinizi saklamak isterseniz hepsini <a>topluca indirebilirsiniz</a>. Bu özelliği kullandığınız için teşekkür eder, zahmet verdiysek özür dileriz.
...
onboardingPromoMessage = Firefox Hesabı ile Screenshots’a giriş yaparsanız daha fazla şey yapabilirsiniz:
onboardingPromoMessageListItem1 = Arşivinize tüm cihazlarınızdan erişebilirsiniz
onboardingPromoMessageListItem2 = Sevdiğiniz ekran görüntülerini sonsuza dek saklayabilirsiniz
onboardingPromoDismissButton = Kapat
    .title = Kapat
onboardingPromoSigninButton = Giriş yap
    .title = Giriş yap
...
shotPageTimeExpirationMessage = Hiçbir şey yapmazsanız bu görüntü <timediff></timediff> kalıcı olarak silinecektir.
...
shotPageTimeExpiresIn = <timediff></timediff> silinecek
...
shotIndexAlertErrorFavoriteShot = Favori görüntü durumu güncellenirken hata oluştu
