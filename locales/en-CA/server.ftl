...
metricsPageVersionQueryDescription = The version of the add-on used during sign-in, in the last 14 days
metricsPageVersionQueryUsers = Number of users signing in
