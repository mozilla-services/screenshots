...
shutdownWarning = <b>Die gespeicherten Bildschirmfotos laufen bald ab.</b> Ab Juni bietet Screenshots keinen Online-Speicher mehr. Möchten Sie Aufnahmen aus Ihrer Bibliothek behalten? <a>Laden Sie sie auf Ihren Computer herunter.</a>
shutdownPageTitle = Screenshots verändert sich
shutdownPageDescription = Ab Juni bietet Screenshots keinen Online-Speicher mehr. Möchten Sie Bildschirmfotos aus Ihrer Bibliothek behalten? Laden Sie die Bildschirmfotos einzeln oder <a>gesammelt</a> herunter. Vielen Dank, dass Sie diese Funktion verwenden. Wir bitten um Entschuldigung für etwaige Unannehmlichkeiten.
shutdownPageContinue = Wir hoffen, dass Sie weiterhin Screenshots zum Aufnehmen, Kopieren und Herunterladen von Bildschirmfotos verwenden.
...
footerReportShot = Bildschirmfoto melden
    .title = Dieses Bildschirmfoto wegen Missbrauchs, Spam oder anderen Problemen melden
...
textToolConfirmButton = Bestätigen
    .title = Bestätigen
textToolCancelButton = Abbrechen
    .title = Abbrechen
