...
onboardingPromoTitle = Што новага ў Firefox Screenshots?
onboardingPromoMessage = Цяпер увайдзіце ў Screenshots з дапамогай уліковага запісу Firefox і зрабіце больш:
onboardingPromoMessageListItem1 = Атрымайце доступ да сваёй бібліятэкі на ўсіх прыладах
onboardingPromoMessageListItem2 = Захоўвайце вашы ўлюбёныя здымкі заўжды
onboardingPromoDismissButton = Адхіліць
    .title = Адхіліць
onboardingPromoSigninButton = Увайсці
    .title = Увайсці
...
# Note: Screenshots is an abbreviation for Firefox Screenshots, and should not be translated.
homePageShaveShareFavoriteDescription = Зрабіце свой лепшы здымак. Потым захавайце яго ў анлайнавай бібліятэцы здымкаў экрана, а Firefox скапіруе спасылку ў ваш буфер абмену, каб здымкам было лёгка падзяліцца. Здымкі ў бібліятэцы аўтаматычна выдаляюцца пасля двух тыдняў, але вы можаце сцерці іх у любы час, або захоўваць даўжэй.
homePageSignInTitle = Вашы здымкі ўсюды
homePageSignInDescription = Увайдзіце ў сэрвіс Screenshots з уліковым запісам Firefox, каб мець доступ да сваіх здымкаў экрана ўсюды, дзе вы карыстаецеся Firefox. І дадатковы бонус: вы можаце захоўваць улюбёныя здымкі безтэрмінова.
...
# Note: do not translate 'Firefox Screenshots' when translating this string
leavePageErrorAuthRequired = Для выдалення вашага ўліковага запісу трэба каб у вас быў усталяваны Firefox Screenshots, або каб вы ўвайшлі ў уліковы запіс Firefox
...
promoTitle = Заўважце!
promoMessage = Абноўленыя прылады рэдагавання могуць абразаць, падсвятляць, і нават дадаваць тэкст да вашага здымку.
promoLink = Паспрабаваць
promoCloseButton =
    .title = Закрыць паведамленне
...
annotationCropButton =
    .title = Абрэзаць
annotationSaveEditButton = Захаваць
    .title = Захаваць змены
annotationCancelEditButton = Скасаваць
    .title = Скасаваць змены
...
textToolConfirmButton = Сцвердзіць
    .title = Сцвердзіць
textToolCancelButton = Скасаваць
    .title = Скасаваць
