...
shutdownPageTitle = تصاویر صفحه در حال تغییر است
shutdownPageDescription = از اواسط خرداد ماه این برنامه دیگر امکان ذخیره آنلاین رو به شما نمی‌دهد. آیا نیاز دارید تصایور را داشته باشید؟ هر تصویر رو به صورت جدا دانلود کنید یا <a> دسته ای</a>. ممنون برای استفاده از این قابلیت  و ما متاسفیم برای هرگونه ناراحتی که به وجود آمده است.
shutdownPageContinue = ما امیدواریم شما به استفاده از این برنامه و گرفتن‌، برداشت و دریافت تصاویر ادامه دهید.
...
shotPageTimeExpirationMessage = اگر کاری انجام ندهید، این عکس <timediff></timediff> به صورت دائمی حذف خواهد شد.
...
shotPageTimeExpiresIn = <timediff></timediff> منقضی می‌شود
# Note: <timediff></timediff> is a placeholder for a past relative time clause, like "1 week ago" or "yesterday"
shotPageTimeExpired = منقضی شده <timediff></timediff>
