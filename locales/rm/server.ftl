...
shotPageKeepOneWeek = 1 emna
shotPageKeepTwoWeeks = 2 emnas
shotPageKeepOneMonth = 1 mais
...
annotationTextSize =
    .title = Grondezza da la scrittira
# Values shown in text size selection dropdown
textSizeSmall = Pitschen
...
metricsPageTotalsQueryExpiredShots = Scrudads (ma restaurabels)
metricsPageTotalsQueryExpiredDeletedShots = Scrudads (e stizzads)
metricsPageShotsQueryTitle = Maletgs per di
metricsPageShotsQueryDescription = Dumber da maletgs creads mintga di (durant ils ultims 30 dis)
metricsPageShotsQueryCount = Dumber da maletgs
metricsPageShotsQueryDay = Di
metricsPageUsersQueryTitle = Utilisaders per di
metricsPageUsersQueryDescription = Dumber dad utilisaders che han creà almain in maletg, per di (ultims 30 dis)
metricsPageUsersQueryCount = Dumber dad utilisaders
metricsPageUsersQueryDay = Di
metricsPageUserShotsQueryTitle = Dumber da maletgs per utilisader
metricsPageUserShotsQueryDescription = Il dumber dad utilisaders che han en total N maletgs
metricsPageUserShotsQueryCount = Dumber dad utilisaders
metricsPageUserShotsQueryShots = Dumber approximativ da maletgs activs (betg scrudads)
metricsPageRetentionQueryTitle = Preservaziun per emna
metricsPageRetentionQueryDescription = Dumber da dis tranter l'emprim e l'ultim maletg dad in utilisader, gruppà tenor l'emna da partenza
metricsPageRetentionQueryUsers = Dumber d'utilisaders
metricsPageRetentionQueryDays = Dumber da dis tranter l'emprim e l'ultim maletg dad in utilisader
metricsPageRetentionQueryFirstWeek = Emna en la quala l'utilisader ha fatg l'emprim maletg
metricsPageTotalRetentionQueryTitle = Preservaziun en total
metricsPageTotalRetentionQueryDescription = Durada durant la quala utilisaders han creà maletgs, gruppà tenor emna
metricsPageTotalRetentionQueryUsers = Dumber d'utilisaders
metricsPageTotalRetentionQueryDays = Dis che l'utilisader ha creà maletgs
metricsPageVersionQueryTitle = Versiun dal supplement
metricsPageVersionQueryDescription = La versiun dal supplement utilisà durant l'annunzia, ils ultims 14 dis
metricsPageVersionQueryUsers = Dumber d'utilisaders annunziads
