...
leavePageButtonCancel = Cancellar
...
shotPageKeepIndefinitelyWithSymbol = Indefinitemente ∞
...
annotationSaveEditButton = Salvar
    .title = Salvar le modification
annotationCancelEditButton = Cancellar
    .title = Cancellar le redaction
...
metricsPageUsersQueryDescription = Numero de usatores qui creava al minus un instantaneo, per die (ultime 30 dies)
...
metricsPageUserShotsQueryDescription = Le numero del usatores qui ha circa N total instantaneos
metricsPageUserShotsQueryCount = Numero de usatores
metricsPageUserShotsQueryShots = Numero approximative del instantaneos (non expirate)
metricsPageRetentionQueryTitle = Reservationes per septimana
metricsPageRetentionQueryDescription = Numero de dies ab la prime instantaneo de un usator al plus recente instantaneo, gruppate per initio septimana
metricsPageRetentionQueryUsers = Numero de usatores
metricsPageRetentionQueryDays = Numero de dies ab la prime instantaneo de un usator al plus recente instantaneo
metricsPageRetentionQueryFirstWeek = Septimana que le usator creava le prime instantaneo
metricsPageTotalRetentionQueryTitle = Retention total
metricsPageTotalRetentionQueryDescription = Durata que le usatores creava instantaneos, gruppate per septimana
metricsPageTotalRetentionQueryUsers = Numero de usatores
metricsPageTotalRetentionQueryDays = Dies que le usator creava instantaneos
metricsPageVersionQueryTitle = Version del additivo
metricsPageVersionQueryDescription = Le version del additivo usate durante authentication, in le ultime 14 dies
