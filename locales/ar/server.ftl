...
shutdownWarning = <b>سينقضي أجل اللقطات المحفوظة قريبا.</b> بدءًا من يناير ستتوقف ميزة التخزين على الشبكة من «لقطات الشاشة». لو أردت الاحتفاظ بما لديك من لقطات، <a>نزّلها على حاسوبك.</a>
shutdownPageDescription = بدءًا من يناير ستتوقف ميزة التخزين على الشبكة من «لقطات الشاشة». لو أردت الاحتفاظ بما لديك من لقطات، نزّلها واحدة واحدة <a>أو على دفعات</a>. نشكركم على استعمال هذه الميزة ونعتذر لهذا الإزعاج.
shutdownPageContinue = نأمل أن تواصلوا استعمال «لقطات الشاشة» لتلتقطوا ما تريدون وتنسخوه وتنزّلوه.
...
annotationCropButton =
    .title = اقتص
annotationSaveEditButton = احفظ
    .title = احفظ التعديل
annotationCancelEditButton = ألغِ
    .title = ألغِ التعديل
