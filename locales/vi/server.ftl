...
footerLinkRemoveAllData = Xóa tất cả dữ liệu
...
creatingPageTitle = Đang tạo { $title }
creatingPageTitleDefault = trang
creatingPageWaitMessage = Đang lưu ảnh chụp…

## Home page

homePageDescription =
    .content = Bạn có thể tạo các ảnh chụp màn hình trực quan trong trình duyệt của mình. Bạn có thể chụp, lưu và chia sẻ ảnh chụp màn hình khi duyệt web bằng Firefox.
homePageButtonMyShots = Đi đến ảnh chụp của tôi
...
leavePageButtonProceed = Tiếp tục
leavePageButtonCancel = Hủy bỏ
leavePageDeleted = Toàn bộ ảnh chụp của bạn đã xóa!

## Not Found page

notFoundPageTitle = Không tìm thấy trang
notFoundPageIntro = Oops.
notFoundPageDescription = Không tìm thấy trang.

## Shot page

# This is the HTML title tag of the page
shotPageTitle = Ảnh chụp: { $originalTitle }
shotPageAlertErrorUpdatingExpirationTime = Lỗi khi thay đổi thời hạn hình ảnh
...
shotPageShareLink = Nhận một liên kết có thể chia sẻ ảnh chụp này:
shotPagePrivacyMessage = Bất kỳ ai có liên kết đều có thể xem ảnh này.
...
# Note: do not translate 'Firefox Screenshots' when translating this string
shotPageDMCAWarning = Nếu ảnh của bạn bị khiếu nại nhiều lần, chúng tôi có thể thu hồi quyền truy cập của bạn vào Ảnh chụp màn hình của Firefox.
# Note: { $url } is a placeholder for a shot page URL
shotPageDMCAIncludeLink = Vui lòng thêm URL của ảnh này trong email của bạn: { $url }
...
shotPageKeepOneWeek = 1 tuần
shotPageKeepTwoWeeks = 2 tuần
...
annotationSaveEditButton = Lưu
    .title = Lưu thay đổi
annotationCancelEditButton = Hủy bỏ
    .title = Hủy thay đổi
annotationCropConfirmButton = Xác nhận
    .title = Lựa chọn xác nhận
annotationCropCancelButton = Hủy bỏ
...
metricsPageShotsQueryDescription = Số lượng ảnh chụp được tạo ra mỗi ngày (trong 30 ngày qua)
...
metricsPageVersionQueryVersion = Phiên bản tiện ích
metricsPageVersionQueryLastSeen = Ngày
metricsPageHeader = Các số liệu
# Note: { $created } is a placeholder for a localized date and time, like '4/21/2017, 3:40:04 AM'
metricsPageGeneratedDateTime = Được tạo lúc: { $created }
# Note { $time } is a placeholder for a number of milliseconds, like '100'
metricsPageDatabaseQueryTime = (cơ sở dữ liệu: { $time }ms)
