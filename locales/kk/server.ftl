...
shutdownWarning = <b>Сақталған скриншоттар мерзімі жақында аяқталады.</b> Маусым айынан бастап, Скриншоттар тегін онлайн сақтау орнын ұсынбайтын болады. Скриншоттарды кітапханаңызда сақтауды қалайсыз ба? <a>Оларды компьютеріңізге жүктеп алыңыз.</a>
shutdownPageTitle = Скриншоттар ауысуда
shutdownPageDescription = Маусым айынан бастап, Скриншоттар тегін онлайн сақтау орнын ұсынбайтын болады. Скриншоттарды кітапханаңызда сақтауды қалайсыз ба? Скриншоттарды бір-бірдеп, немесе <a>топтап</a> жүктеп алыңыз. Бұл мүмкіндікті қолданғаныңыз үшін рахмет, ыңғайсыздық үшін кешірім сұраймыз.
shutdownPageContinue = Скриншоттар мүмкіндігін скриншоттарды түсіру, көшіру және жүктеп алу үшін қолдануды жалғастыратыныңызға үміттенеміз.
...
# Note: Screenshots is an abbreviation for Firefox Screenshots, and should not be translated.
homePageDownloadCopyDescription = Ең жақсы скриншотты түсіріңіз. Скриншоттар көмегімен таңдауыңызды жүктеп алу немесе алмасу буферіне көшіруге болады.
...
shotPageScreenshotsDescriptionServerless = Скриншоттар қарапайым болды. Firefox-тан шықпай-ақ, скриншоттарды түсіріп, жүктеп алыңыз.
...
annotationCropButton =
    .title = Қию
annotationSaveEditButton = Сақтау
    .title = Түзетуді сақтау
annotationCancelEditButton = Бас тарту
    .title = Түзетуден бас тарту
...
exportInstructions = Экспорттау үшін: Файл> Бетті қалайша сақтау… қолданыңыз және скриншоттарды { $folder } бумасынан таба аласыз
