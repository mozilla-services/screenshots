...
shotPageShareTwitter =
    .title = Kongsi di Twitter
shotPageSharePinterest =
    .title = Kongsi di Pinterest
shotPageShareEmail =
    .title = Kongsi pautan via e-mel
shotPageShareLink = Dapatkan pautan untuk kongsi syot ini:
...
settingsDisconnectButton = Memutuskan
    .title = Memutuskan
settingsGuestAccountMessage = Akaun Tetamu
settingsSignInInvite = Daftar masuk untuk sync semua peranti
settingsSignInButton = Daftar masuk
    .title = Daftar masuk
...
shotIndexNonFavoriteIcon =
    .title = Ini bukan syot kegemaran dan akan luput
