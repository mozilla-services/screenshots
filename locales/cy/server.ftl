...
shotPageKeepOneWeek = Wythnos
shotPageKeepTwoWeeks = Pythefnos
shotPageKeepOneMonth = Mis
...
metricsPageTotalsQueryExpiredShots = Wedi dod y ben (ond adferadwy)
metricsPageTotalsQueryExpiredDeletedShots = Wedi dod i ben (ac wedi eu dileu)
metricsPageShotsQueryTitle = Lluniau fesul Diwrnod
metricsPageShotsQueryDescription = Y nifer o luniau crëwyd bob diwrnod ( y 30 diwrnod diwethaf)
metricsPageShotsQueryCount = Nifer y lluniau
metricsPageShotsQueryDay = Diwrnod
metricsPageUsersQueryTitle = Defnyddwyr fesul Diwrnod
metricsPageUsersQueryDescription = Y nifer y defnyddwyr sydd wedi creu o leiaf un llun, fesul diwrnod (30 diwrnod diwethaf)
metricsPageUsersQueryCount = Y nifer y defnyddwyr
metricsPageUsersQueryDay = Diwrnod
metricsPageUserShotsQueryTitle = Y nifer y Lluniau fesul Defnyddiwr
metricsPageUserShotsQueryDescription = Y nifer y defnyddwyr sydd â cyfanswm o N llun
metricsPageUserShotsQueryCount = Y nifer o ddefnyddwyr
metricsPageUserShotsQueryShots = Y niferoedd yn fras o luniau (heb ddod i ben) gweithredol
metricsPageRetentionQueryTitle = Wedi eu cadw yn ôl Wythnos
metricsPageRetentionQueryDescription = Y nifer o ddyddiau o lun cyntaf y defnyddiwr i'r llun diweddaraf, wedi eu grwpio yn ôl wythnos yn cychwyn
metricsPageRetentionQueryUsers = Y nifer o ddefnyddwyr
metricsPageRetentionQueryDays = Diwrnodau o lun cyntaf y defnyddiwr i'r diweddaraf
metricsPageRetentionQueryFirstWeek = Yr wythnos creodd y defnyddiwr lun
metricsPageTotalRetentionQueryTitle = Y Cyfan wedi eu Cadw
metricsPageTotalRetentionQueryDescription = Hyd y cyfnod y mae'r defnyddwyr wedi bod yn creu lluniau, yn ôl wythnos
metricsPageTotalRetentionQueryUsers = Yn ôl nifer y defnyddwyr
metricsPageTotalRetentionQueryDays = Yn ôl y diwrnodau y mae'r defnyddiwr wedi bod yn creu lluniau
metricsPageVersionQueryTitle = Fersiwn yr Ychwanegyn
metricsPageVersionQueryDescription = Y fersiwn sydd wedi cael ei ddefnyddio yn ystod y mewngofnodiad, yn ystod yr 14 diwrnod diwethaf
metricsPageVersionQueryUsers = Y nifer o ddefnyddwyr sydd wedi eu mewngofnodi
