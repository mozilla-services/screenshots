...
metricsPageShotsQueryTitle = Ekrankopioj ĉiutage
...
metricsPageUsersQueryTitle = Uzantoj laŭ tago
metricsPageUsersQueryDescription = Nombro de uzantoj kiuj kreis minimume unu ekrankopion, laŭ tago (lastaj 30 tagoj)
