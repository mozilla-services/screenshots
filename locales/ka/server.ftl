...
footerLinkPrivacy = პირადი მონაცემების დაცვის განაცხადი
footerReportShot = მოხსენება გადაღებულ სურათზე
    .title = მოგვახსენეთ სურათთან დაკავშირებული დარღვევის, არასასურველი შიგთავსის ან სხვა ხარვეზის შესახებ
...
# Note: Screenshots is an abbreviation for Firefox Screenshots, and should not be translated.
homePageShaveShareFavoriteDescription = გადაიღეთ სასურველი სურათი. შემდეგ შეინახეთ სურათების ინტერნეტ-ბიბლიოთეკაში და Firefox თავისით დააკოპირებს ბმულს, მარტივად გაზიარებისთვის. ბიბლიოთეკაში არსებულ გადაღებულ სურათებს ვადა გაუვა ორ კვირაში, თუმცა ნებისმიერ დროს შეგიძლიათ მათი წაშლა ან ვადის გახანგრძლივება.
...
shotIndexAlertErrorFavoriteShot = შეცდომა, სურათის რჩეული მდგომარეობის განახლებისას
