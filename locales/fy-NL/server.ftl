...
onboardingPromoMessage = Jo kinne jo no oanmelde by Screenshots mei in Firefox-account en mear dwaan:
onboardingPromoMessageListItem1 = Jo biblioteek benaderje op al jo apparaten
onboardingPromoMessageListItem2 = Jo favorite ôfbyldingen foar altyd bewarje
onboardingPromoDismissButton = Slute
    .title = Slute
onboardingPromoSigninButton = Oanmelde
    .title = Oanmelde
...
# Note: do not translate 'Firefox Screenshots' when translating this string
leavePageErrorAuthRequired = Jo moatte Firefox Screenshots ynstallearre hawwe of by jo Firefox-account oanmeld wêze om jo account fuort te smiten
...
annotationCropButton =
    .title = Bysnije
annotationSaveEditButton = Bewarje
    .title = Bewurking bewarje
annotationCancelEditButton = Annulearje
    .title = Bewurkjen annulearje
...
shotIndexNonFavoriteIcon =
    .title = Dizze ôfbylding is gjin favoryt en sil ferrinne
...
metricsPageShotsQueryDescription = Oantal ôfbyldingen dat elke dei makke is (foar de ôfrûne 30 dagen)
metricsPageShotsQueryCount = Oantal ôfbyldingen
metricsPageShotsQueryDay = Dei
metricsPageUsersQueryTitle = Brûkers op dei
metricsPageUsersQueryDescription = Oantal brûkers dat op syn minst ien ôfbylding makke hat, op dei (ôfrûne 30 dagen)
metricsPageUsersQueryCount = Oantal brûkers
metricsPageUsersQueryDay = Dei
metricsPageUserShotsQueryTitle = Oantal ôfbyldingen per brûker
metricsPageUserShotsQueryDescription = It oantal brûkers dy't ûngefear N ôfbyldingen hawwe
