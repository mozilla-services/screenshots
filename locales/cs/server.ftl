...
shutdownPageDescription = Od června nebude služba Screenshots nadále nabízet online úložiště pro sdílení. Pokud chcete zachovat snímky nahrané ve vaší knihovně, stáhněte si je jednotlivě nebo jako <a>kompletní zálohu</a>. Děkujeme za používání této funkce a omlouváme se za případné nepříjemnosti.
shutdownPageContinue = Doufáme, že si i nadále budete užívat pořizování snímků jako doposud.
# Text used in Firefox Account onboarding promo shown below
# Sign in button in header
onboardingPromoTitle = Co je nového ve Firefox Screenshots?
onboardingPromoMessage = Po přihlášení účtem Firefoxu:
onboardingPromoMessageListItem1 = Získáte přístup ke své knihovně ze všech zařízení
onboardingPromoMessageListItem2 = Můžete ukládat své oblíbené snímky navždy
onboardingPromoDismissButton = Zavřít
    .title = Zavřít
onboardingPromoSigninButton = Přihlásit se
    .title = Přihlásit se
...
shotPageCopyActionLabel = Kopírovat
...
settingsFxaConnectDescription = Pro přístup k vašim snímkům z kteréhokoliv zařízení se stačí přihlásit.
...
shotIndexAlertErrorFavoriteShot = Při aktualizaci stavu oblíbeného snímku došlo k chybě
