...
bannerSignIn = <a>Войдите или зарегистрируйтесь</a> для получения доступа к вашим снимкам с различных устройств и навсегда сохраните необходимые.
bannerUpsell = { gScreenshotsDescription } <a>Загрузить Firefox</a>
shutdownWarning = <b>Срок хранения сохранённых снимков экрана скоро истекает.</b> Начиная с июня, Screenshots более не будет предлагать использовать онлайн-хранилище. Хотите сохранить снимки из своей библиотеки? <a> Загрузите их на свой компьютер.</a>
shutdownPageTitle = Screenshots изменяются
shutdownPageDescription = Начиная с июня, онлайн-хранилище для скриншотов более не будет доступно. Хотите сохранить снимки из своей библиотеки? Загрузите их поодиночке или <a>все сразу</a>. Спасибо за использование этой функции и извините за неудобства.
shutdownPageContinue = Надеемся, вы продолжите использовать Screenshots для создания, копирования и загрузки скриншотов.
# Text used in Firefox Account onboarding promo shown below
# Sign in button in header
onboardingPromoTitle = Что нового в Firefox Screenshots?
onboardingPromoMessage = Теперь, вы можете сделать больше, войдя в Screenshots через Аккаунт Firefox:
onboardingPromoMessageListItem1 = Получить доступ к своей библиотеке на всех ваших устройствах
onboardingPromoMessageListItem2 = Навсегда сохранить свои любимые снимки
onboardingPromoDismissButton = Убрать
    .title = Убрать
onboardingPromoSigninButton = Войти
    .title = Войти
...
shotPageCopyActionLabel = Скопировать
...
shotPageTimeExpirationMessage = Если вы ничего не будете делать, снимок будет удалён навсегда <timediff></timediff>.
...
shotPageTimeExpiresIn = срок хранения истечёт <timediff></timediff>
# Note: <timediff></timediff> is a placeholder for a past relative time clause, like "1 week ago" or "yesterday"
shotPageTimeExpired = срок хранения истёк <timediff></timediff>
...
promoTitle = Делайте заметки!
promoMessage = Обновлённые инструменты редактирования позволяют вам обрезать, выделять и даже добавлять текст на ваши снимки.
promoLink = Попробуйте
promoCloseButton =
...
textToolConfirmButton = Подтвердить
    .title = Подтвердить
textToolCancelButton = Отмена
    .title = Отмена
...
settingsDisconnectButton = Отсоединить
    .title = Отсоединить
settingsGuestAccountMessage = Гостевой аккаунт
settingsSignInButton = Войти
    .title = Войти
...
settingsFxaConnectDescription = Вы можете войти для доступа к вашим скриншотам с различных устройств.
