...
gMyShots = Móje fota wobrazowki
gHomeLink = Startowy bok
gNoShots =
    .alt = Žedne fota wobrazowki namakane
gScreenshotsDescriptionServerless = Fota wobrazowki lažko napórane. Napórajśo a ześěgniśo fota wobrazowki, mimo aby Firefox spušćił.
...
footerReportShot = Toś to foto wobrazowki k wěsći daś
    .title = Toś to foto wobrazowki znjewužywanja, spama abo drugich problemow dla k wěsći daś
footerLinkFaqs = Cesto stajone pšašanja
...
homePageDescription =
    .content = Intuitiwne fota wobrazowki direktne z wobglědowaka. Móžośo fota wobrazowki cyniś, składowaś a źěliś, mjaztym až pśeglědujośo web z pomocu Firefox.
homePageButtonMyShots = K mójim fotam wobrazowki
...
homePageDownloadCopy = Ześěgnuś abo kopěrowaś
# Note: Screenshots is an abbreviation for Firefox Screenshots, and should not be translated.
homePageDownloadCopyDescription = Napórajśo swójo nejlěpše foto wobrazowki. Fota wobrazowki wam zmóžnja, waš wuběrk ześěgnuś abo jen direktnje do wašogo mjazywótkłada kopěrowaś.
...
shotPageShareLink = Napórajśo wótkaz, aby toś to foto wobrazowki źělił:
shotPagePrivacyMessage = Kuždy z toś tym wótkazom móžo se toś to foto wobrazowki woglědaś.
shotPageCopyImageText =
    .label = Wobrazowy tekst kopěrowaś
shotPageConfirmDeletion = Cośo toś to foto wobrazowki napšawdu na pśecej wulašowaś?
# Note: <timediff></timediff> is a placeholder for a future relative time clause like 'in 3 days' or 'tomorrow'
shotPageTimeExpirationMessage = Jolic nic njecyniśo, se toś to foto wobrazowki na pśecej wulašujo <timediff></timediff>.
# Note: { $date } is a placeholder for a localized future date as returned by Date.toLocaleString.
# For example, in en-US, { $date } could be "7/12/2017, 1:52:50 PM".
shotPageRestoreButton = wótnowiś až do { $date }
shotPageExpiredMessage = Toś to foto wobrazowki jo spadnjone.
# Note: This phrase is followed by an empty line, then the URL of the source page
shotPageExpiredMessageDetails = How jo bok, z kótaregož jo se spócetnje napórało:
shotPageDeleteButton =
    .title = Toś to foto wobrazowki wulašowaś
...
shotPageScreenshotsDescriptionServerless = Fota wobrazowki lažko napórane. Napórajśo a ześěgniśo fota wobrazowki, mimo aby Firefox spušćił.
...
shotPageTimeExpiresIn = spadnjo <timediff></timediff>
# Note: <timediff></timediff> is a placeholder for a past relative time clause, like "1 week ago" or "yesterday"
shotPageTimeExpired = spadnjony <timediff></timediff>
...
annotationCropButton =
    .title = Wurězaś
annotationSaveEditButton = Składowaś
    .title = Změnu składowaś
annotationCancelEditButton = Pśetergnuś
    .title = Wobźěłanje pśetergnuś
...
copyImageErrorTitle = Něco njejo se raźiło
copyImageErrorMessage = Njejo móžno, wašo foto wobrazowki do mjazywótkłada kopěrowaś.

## Settings Page

settingsDisconnectButton = Zwisk źěliś
    .title = Zwisk źěliś
settingsGuestAccountMessage = Góstne konto
...
settingsFxaConnectDescription = Móžośo se pśizjawiś, aby pśistup k swójim fotam wobrazowki pśez rědy měł.
...
shotIndexNonFavoriteIcon =
    .title = To njejo woblubowane foto wobrazowki a pśepadnjo
...
exportInstructions = Aby eksportěrował, wužywajśo Dataja > Bok składowaś ako… a namakajośo swóje fota wobrazowki w zarědniku { $folder }
