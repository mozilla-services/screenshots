...
gMyShots = Moji snimci
gHomeLink = Početna
gNoShots =
    .alt = Snimci nisu pronađeni
gScreenshotsDescription = Snimite zaslon jednostavno. Snimite, sačuvajte i dijelite snimke zaslona bez da napustite Firefox.
...
footerLinkPrivacy = Napomena o privatnosti
footerLinkFaqs = ČPP
...
creatingPageTitle = Pravim snimak stranice { $title }
...
homePageDescription =
    .content = Intuitivni snimci zaslona ugrađeni direktno u vaš pretraživač. Snimite, spremite i dijelite snimke zaslona dok pretražujete web koristeći Firefox.
...
homePageHowScreenshotsWorks = Kako Firefox Screenshots radi
homePageGetStartedTitle = Započnite
# Note: Screenshots is an abbreviation for Firefox Screenshots, and should not be translated.
homePageGetStartedDescription = Pronađite novu ikonu za snimke zaslona na vašoj alatnoj traci. Odaberite je i meni za snimke zaslona će se pojaviti na vrhu prozora pretraživača.
# Note: Screenshots is an abbreviation for Firefox Screenshots, and should not be translated.
homePageGetStartedDescriptionPageAction = Odaberite ikonu snimke ekrana iz menija radnji stranice u adresnoj traci i meni snimke ekrana će se pojaviti povrh prozora vašeg pretraživača.
homePageCaptureRegion = Uhvatite dio stranice
# Note: Screenshots is an abbreviation for Firefox Screenshots, and should not be translated.
homePageCaptureRegionDescription = Kliknite i vucite kako biste odabrali područje koje želite snimiti. Ili samo pređite mišem i kliknite — snimke zaslona će odabrati područje za vas. Sviđa vam se šta vidite? Odaberite Sačuvaj kako biste pristupili svojoj snimci na internetu ili dugme sa strelicom prema dole kako biste je preuzeli na svoj računar.
