...
shutdownWarning = <b>Запазените снимки скоро губят давност.</b> Считано но юни Screenshots няма да предлага съхранение онлайн. Искате ли да запазите снимките от библиотеката си? <a>Изтеглете ги  на компютъра си.</a>
...
exportInstructions = За да изтеглите изберете: Файл > Запазване като… и ще намерите снимките в папка { $folder }
