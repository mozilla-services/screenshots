  ...
  render() {
    return (
      <div>
        ...
        <p>
          ("Page Shot"). By accessing the Page Shot add-on or the Page Shot service, you agree to be bound by these Terms. If a Shot has been shared with you, your access to the Shot is governed by our Websites & Communications{" "}
          <a target="_blank" href="https://www.mozilla.org/en-US/about/legal/terms/mozilla/">Terms of Use</a>
          .
        </p>
        <h3>Test Pilot</h3>
        <p>
        ...
        <p>
          The Test Pilot Page Shot website and the{" "}
          <a href="https://testpilot.firefox.com/privacy" target="blank">Test Pilot Privacy Notice</a>
          {" "}describes details on what we receive from your use of Page Shot and how we use that information. We use the information we receive through Page Shot as described in our{" "}
          <a href="https://www.mozilla.org/privacy/" target="blank">Mozilla Privacy Policy</a>
          .
        </p>
...
class Privacy extends React.Component {
  render() {
    return (
      <div>
        <p>
          We care about your privacy. When Mozilla (that's us) collects information about you, our{" "}
          <a href="https://www.mozilla.org/privacy/" target="blank">Mozilla Privacy Policy</a>
          {" "}describes how we handle that information.
        </p>
        <p>
          Page Shot is an experimental service for Test Pilot users that allows them to capture, save, and share images of webpages (“Shots”). For Test Pilot users of the Page Shot add-on and Page Shot service, the data we collect is described in the Page Shot Test Pilot experiment page and in the{" "}
          <a href="https://testpilot.firefox.com/privacy" target="_blank">Test Pilot Privacy Notice.</a>
        </p>
        <p>
          For all visits to the Page Shot website (for example, if someone has shared a Shot with you), the data we collect is described in our{" "}
          <a href="https://www.mozilla.org/privacy/websites/" target="_blank">
