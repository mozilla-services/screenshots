  ...
  render() {
    return (
      <reactruntime.HeadTemplate {...this.props}>
        <script src={this.props.staticLink("/static/js/homepage-bundle.js")} async />
        ...
        <meta
          property="og:image"
          content="https://testpilot-prod.s3.amazonaws.com/experiments_experiment/2/d/2d3eaabad489f46bf835790776c0f74a_image_1475081824_0659.jpg"
        />
        <meta
          name="twitter:image"
          content="https://testpilot-prod.s3.amazonaws.com/experiments_experiment/2/d/2d3eaabad489f46bf835790776c0f74a_image_1475081824_0845.jpg"
        />
...
class Body extends React.Component {
  ...
  render() {
    ...
    if (this.props.showMyShots) {
      myShots = (
        <button className="pageshot-myshots" onClick={this.onClickMyShots.bind(this)}>
          <div className="pageshot-pre-myshots" />
          <span className="pageshot-myshots-text">My Shots</span>
          <div className="pageshot-post-myshots" />
        </button>
      );
    }
    return (
      <reactruntime.BodyTemplate {...this.props}>
        <div className="vertical-centered-content-wrapper">
          <div className="stars" />
          <div className="copter fly-up" />
          <h1>Welcome to Page Shot</h1>
          <a className="button primary" href="https://testpilot.firefox.com/experiments/page-shot">
            Install Page Shot with Firefox Test Pilot
          </a>
          {myShots}
          <div className="social-links">
            <a
              href="https://github.com/mozilla-services/pageshot"
              target="_blank"
