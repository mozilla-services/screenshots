...
exports.main = function (options) {
  ...
  if (prefServiceBranch.getPrefType("browser.tabs.remote.autostart") &&
      prefServiceBranch.getBoolPref("browser.tabs.remote.autostart")) {
    console.log("------------------------------------------------------------");
    console.log("PageShot does not work with e10s, disabling");
    console.log("------------------------------------------------------------");
    require("sdk/tabs").open({
      url: backend + "/no-e10s.html"
    });
    return;
  }
