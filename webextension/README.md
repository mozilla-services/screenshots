This contains all the files for the WebExtension.  It does not require any build process – you can run the extension out of this directory, or use `web-ext build`
